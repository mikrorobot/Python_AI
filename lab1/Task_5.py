...
print("Chyzhmotria_confusion_matrix:\n", Chyzhmotria_confusion_matrix(actual, predicted_RF))
...
assert Chyzhmotria_accuracy_score(actual, predicted_RF) == accuracy_score(actual, predicted_RF), \
    'my accuracy_score failed RF'

assert Chyzhmotria_accuracy_score(actual, predicted_LR) == accuracy_score(actual, predicted_LR), \
    'my accuracy_score failed LR'

print("My accuracy score on RF:", Chyzhmotria_accuracy_score(actual, predicted_RF))
print("My accuracy score on LR:", Chyzhmotria_accuracy_score(actual, predicted_LR))
...
assert Chyzhmotria_recal_score(actual, predicted_RF) == recall_score(actual, predicted_RF),\
    'my recal_score fails on RF'

assert Chyzhmotria_recal_score(actual, predicted_LR) == recall_score(actual, predicted_LR),\
...
assert Chyzhmotria_precision_score(actual, predicted_RF) == precision_score(actual, predicted_RF),\
    'my precision_score fails on RF'

assert Chyzhmotria_precision_score(actual, predicted_LR) == precision_score(actual, predicted_LR),\
    'my precision_score fails on LR'

print("My precision score on RF:", Chyzhmotria_precision_score(actual, predicted_RF))
print("My precision score on LR:", Chyzhmotria_precision_score(actual, predicted_LR))
...
assert Chyzhmotria_f1_score(actual, predicted_RF) == f1_score(actual, predicted_RF),\
    'my f1_score fails on RF'

assert Chyzhmotria_f1_score(actual, predicted_LR) == f1_score(actual, predicted_LR),\
